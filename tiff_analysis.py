...
TOP_LEVEL_FOLDER = "/Volumes/WD_Elements/C3M10"  # Change this to the folder you want to process but you have to include the top level strain folder
...
CELL_CLUSTER_DISTANCE_THRESHOLD = 5
